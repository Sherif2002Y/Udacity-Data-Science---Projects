...
def db_path():
    ...
    # return a pathlib.Path object for the `employee_events.db` file
    employee_events_path = project_root / "python-package" / "employee_events" / "employee_events.db"
    return employee_events_path
...
def test_db_exists(db_path):
    ...
    # at the location provided by the `db_path` fixture
